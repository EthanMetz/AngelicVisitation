...
lake. It begins to glow. Rivers of life come out of it onto the bank shore, and surge across the ground into you. You take it all in and decide to explore
    the forest, where Wisdom, Might, Goodness and mercy can be found. Who do you want to be blessed by, Wisdom, or Might? Enter one of their names to recieve an impartation of their charactor
    and knowledge of their behavior. ''').lower()
    if choice2 == "wisdom":
